...
class WithSchedule_ItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/schedules/{schedule_id}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithSchedule_ItemRequestBuilder:
        """
        ...
        return WithSchedule_ItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class WithSchedule_ItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class WithSchedule_ItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
