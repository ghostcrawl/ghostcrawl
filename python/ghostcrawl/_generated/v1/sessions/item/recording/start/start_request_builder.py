...
class StartRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/sessions/{profile_%2Did}/recording/start", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
        POST /v1/sessions/{profile_id}/recording/start. Tier: interaction (recording_enabled on org). Returns 201 RecordingResponse;
