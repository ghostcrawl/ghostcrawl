...
if TYPE_CHECKING:
    ...
    from .append.append_request_builder import AppendRequestBuilder
...
class RowsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/datasets/{name}/rows{?cursor*,limit*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RowsRequestBuilderGetQueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    @property
    def append(self) -> AppendRequestBuilder:
        """
        The append property
        """
        from .append.append_request_builder import AppendRequestBuilder

        return AppendRequestBuilder(self.request_adapter, self.path_parameters)
