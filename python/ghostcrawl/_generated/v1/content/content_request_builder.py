...
class ContentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/content", path_parameters)
    
    async def post(self,body: ContentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
        ...
        param body: POST /v1/content request body, render a URL and return its content.
    ...
    def to_post_request_information(self,body: ContentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        render a URL and return its content as a JSON envelope. Equivalent to /v1/scrape returning the rendered content field. Gated exactly like /v1/scrape (daily request quota + GB egress cap); works on every engine.
        param body: POST /v1/content request body, render a URL and return its content.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
